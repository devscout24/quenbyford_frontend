        ...
        <section className="max-w-7xl mx-auto my-16 bg-white">
            ...
            >
                {programs.map((program) => (
                    ...
                    <Card
                        className="border-gray-100  border ring-0 shadow-xl rounded-xl overflow-hidden p-6"
                    >
                        <CardContent className="p-0 space-y-6">
                            ...
                            <div className="space-y-3">
                                <h3 className="text-2xl font-bold text-black w-[550px]">
                                    {program.title}
                                </h3>
                                <p className="text-[#000000]/60 italic text-[14px] font-normal leading-relaxed w-[510px]   ">
                                    {program.description}
                                </p>
                            </div>
