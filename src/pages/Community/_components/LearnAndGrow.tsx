    ...
    <section className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 my-8 sm:my-16 bg-white">
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <Card className="border border-slate-100 ring-0 shadow-sm rounded-2xl sm:rounded-4xl p-4 sm:p-8 w-full flex flex-col items-center">
            ...
            <h3 className="text-xl sm:text-[32px] font-bold text-black">Upcoming Workshop</h3>
            <p className="text-black font-normal text-base sm:text-xl mb-4 sm:mb-8">join Our in Person and virtual Workshop</p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
              {[1, 2, 3].map((i) => (
                <div key={i} className={`border border-orange-100 rounded-2xl p-4 sm:p-6 text-center ${i === 3 ? 'col-span-1' : ''}`}>
                  <span className="text-[10px] text-orange-500 font-bold border border-orange-200 px-2 py-1  rounded-full uppercase">
                    ✦ Virtual Workshop
                  </span>
                  <h4 className="text-[14px] font-bold text-black mt-4 sm:mt-10 mb-3">AI for Small Businesses</h4>
                  <p className="text-[12px] font-normal text-black mb-4 sm:mb-10">March 15 2026</p>
        ...
        <motion.div variants={itemVariants}>
          <Card className="border border-slate-100 ring-0 shadow-sm rounded-2xl sm:rounded-4xl p-4 sm:p-8 w-full flex flex-col items-center">
            ...
            <h3 className="text-xl sm:text-[32px] font-bold text-black">Upcoming Workshop</h3>
            <p className="text-black font-normal text-base sm:text-xl mb-4">join Our in Person and virtual Workshop</p>
            <span className="font-bold text-black mb-6 text-[16px]">Featured Courses</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-3 mb-6 sm:mb-10 w-full px-2 sm:px-4">
              <div className="flex items-center gap-2 text-[16px] text-[#64748B] font-medium">
                <PlayCircle className="w-5 h-5 sm:w-6 sm:h-6 text-[#1E88E5] shrink-0" /> <span className="text-xs sm:text-[16px]">On-demand video courses</span>
              </div>
              <div className="flex items-center gap-2 text-[16px] text-[#64748B] font-medium">
                <Download className="w-5 h-5 sm:w-6 sm:h-6 text-[#1E88E5] shrink-0" /> <span className="text-xs sm:text-[16px]">Downloadable resources</span>
              </div>
              <div className="flex items-center gap-2 text-[16px] text-[#64748B] font-medium">
                <Award className="w-5 h-5 sm:w-6 sm:h-6 text-[#1E88E5] shrink-0" /> <span className="text-xs sm:text-[16px]">Completion certificates</span>
              </div>
              <div className="flex items-center gap-2 text-[16px] text-[#64748B] font-medium">
                <Users className="w-5 h-5 sm:w-6 sm:h-6 text-[#1E88E5] shrink-0" /> <span className="text-xs sm:text-[16px]">Community discussions</span>
              </div>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
              {[1, 2, 3].map((i) => (
                <div key={i} className="border border-blue-100 rounded-2xl p-4 space-y-2 text-center">
                  <h4 className="text-[14px] font-bold text-black mt-2 mb-3">AI for Fundamental Course</h4>
                  <ul className="text-[12px] text-black space-y-2 mb-10 text-left">
                    <li>• AI Fundamentals</li>
                    <li>• Learn the basics of AI</li>
                  </ul>
            ...
            <div className="mt-auto w-full">
              <Button className="w-full mt-6 sm:mt-10 py-5 sm:py-7 bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full">
                Access Training Pannel
              </Button>
            </div>
          </Card>
        </motion.div>
