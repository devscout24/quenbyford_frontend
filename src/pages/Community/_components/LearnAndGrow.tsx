    ...
    <section className="max-w-7xl mx-auto my-16 bg-white">
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <Card className="border border-slate-100 ring-0 shadow-sm rounded-4xl p-8 w-155 h-237 flex flex-col items-center">
          ...
          <h3 className="text-[32px] font-bold text-black ">Upcoming Workshop</h3>
          <p className="text-black font-normal text-xl mb-8">join Our in Person and virtual Workshop</p>

          <div className="grid grid-cols-2 gap-4 w-128 h-62 ">
            {[1, 2, 3].map((i) => (
              <div key={i} className={`border border-orange-100 rounded-2xl p-6  text-center ${i === 3 ? 'col-span-1' : ''}`}>
                <span className="text-[10px] text-orange-500 font-bold border border-orange-200 px-2 py-1  rounded-full uppercase">
                  ✦ Virtual Workshop
                </span>
                <h4 className="text-[14px] font-bold text-black mt-10 mb-3">AI for Small Businesses</h4>
                <p className="text-[12px] font-normal text-black mb-10">March 15 2026</p>
          ...
          <div className="mt-auto w-full">
            <Button className="w-full mt-10 py-7 bg-[#F97316] hover:bg-[#F97316] text-white text-[16px] font-bold rounded-full">
              View All Workshop
            </Button>
          </div>
        ...
        <motion.div variants={itemVariants}>
          ...
          <h3 className="text-[32px] font-bold text-black ">Upcoming Workshop</h3>
          <p className="text-black font-normal text-xl mb-4">join Our in Person and virtual Workshop</p>
          <span className="font-bold text-black mb-6 text-[16px]">Featured Courses</span>

          {/* Icon List */}
          <div className="grid grid-cols-2 gap-x-4 gap-y-3 mb-10 w-full px-4">
            <div className="flex items-center gap-2 text-[16px] text-[#64748B] font-medium">
              <PlayCircle className="w-6 h-6 text-[#1E88E5]" /> On-demand video courses
            </div>
            <div className="flex items-center gap-2 text-[16px] text-[#64748B] font-medium">
              <Download className="w-6 h-6 text-[#1E88E5]" /> Downloadable resources
            </div>
            <div className="flex items-center gap-2 text-[16px] text-[#64748B] font-medium">
              <Award className="w-6 h-6 text-[#1E88E5]" /> Completion certificates
            </div>
            <div className="flex items-center gap-2 text-[16px] text-[#64748B] font-medium">
              <Users className="w-6 h-6 text-[#1E88E5]" /> Community discussions
            </div>
          </div>

          <div className="grid grid-cols-2 gap-4 w-[514px] h-[250px] ">
            {[1, 2, 3].map((i) => (
          ...
          <div className="mt-auto w-full">
            <Button className="w-full mt-10 py-7 bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full">
