...
const NewsCard = ({ title, imageSrc, children, buttonText }: NewsCardProps) => {
  return (
      ...
      <div className="flex flex-col md:flex-row justify-center items-start gap-12 p-10  bg-white">
        ...
        >
          <p className=''>
            ...
            Be sure to <span className="text-[#f97316] cursor-pointer hover:underline font-medium">subscribe</span> to be notified!
          </p>
        </NewsCard>
      </div>
    </div>
