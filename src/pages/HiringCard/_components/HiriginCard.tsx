    ...
    <section className="py-20 bg-white">
      <div className="max-w-360 mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <JobCard price="$25" duration="1 Month" />
          <JobCard price="$125" duration="6 Month" />
          <JobCard price="$225" duration="12 Month" />
        </div>
      </div>
    </section>
  );
...
const JobCard = ({ price, duration }: JobCardProps) => (
  <div className="bg-white border-2 border-[#1D91E7] shadow-[#1D91E7]/10 shadow-2xl rounded-xl p-8  flex flex-col items-start transition-transform hover:scale-105">
    ...
    <h3 className="text-3xl font-bold text-black my-5">None Member</h3>
    <p className="text-gray-400 text-sm mb-6">website and social media</p>
    ...
    <button className="w-full bg-[#1D91E7] hover:bg-[#157dc9] text-white py-3 rounded-2xl font-bold text-sm transition-colors shadow-md">
      Get Started
    </button>
  </div>
);
