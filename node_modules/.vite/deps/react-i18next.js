...
import { t as require_shim } from "./shim-BJWfcMeD.js";
...
var renderNodes = (children, knownComponentsMap, targetString, i18n, i18nOptions, combinedTOpts, shouldUnescape) => {
	...
	const pushTranslatedJSX = (child, inner, mem, i, isVoid) => {
		if (child.dummy) {
			...
			if (c.type === import_react.Fragment) return (0, import_react.createElement)(import_react.Fragment, { key: i }, isVoid ? null : inner);
			...
			override.i18nIsDynamicList = void 0;
